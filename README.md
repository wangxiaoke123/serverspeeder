...
版本CentOS/37/3.12.9-x86_64-linode37/x64/3.10.54.8/0/serverspeeder_2495
...
其它版本试例wget -N --no-check-certificate https://github.com/91yun/serverspeeder/raw/master/serverspeeder-v.sh && bash serverspeeder-v.sh CentOS 7.2 3.10.0-327.el7.x86_64 x64 3.11.20.5 serverspeeder_72327
